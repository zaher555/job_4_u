...
<body>
    <div class="container mt-5 w-50 bg-white p-5 rounded">
        ...
        <button class="w-25 m-auto text-white rounded">Update</button>
        <button class=" w-25 m-auto text-white rounded">Cancel</button>
    </div>
